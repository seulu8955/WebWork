...
<%
	...
	String realPath=application.getRealPath("/upload");// 변경 가능성이 있는 영역 예를들면 /WEB-INF 를 통해 비공개 경로로 변경도 가능 
	...
	*/
	...
	String orgFileName=mr.getOriginalFileName("myFile");//"myFile"은 업로드 폼의 name 속성 밸류와 일치시켜야함
	...
	dto.setTitle(title);
	dto.setOrgFileName(orgFileName);//파일목록을 출력하거나 파일을 다운로드 할때
	dto.setSaveFileName(saveFileName);//파일을 다운로드 하기위해 (FilerInputStream 객체를 생성할때)
